...
fun CollectionSheet(
    ...
    ModalBottomSheet(
        ...
        Column(modifier = Modifier.padding(bottom = MnemaSpacing.XLarge)) {
            Text(
                text = "Collections",
                style = MaterialTheme.typography.titleMedium,
                modifier = Modifier.padding(horizontal = MnemaSpacing.Large, vertical = MnemaSpacing.Small)
            )
            ...
            if (collections.isEmpty() && !isCreating) {
                Text(
                    ...
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(horizontal = MnemaSpacing.Large, vertical = MnemaSpacing.XLarge)
                )
            } else {
            ...
            if (isCreating) {
                ...
                TextButton(
                    ...
                    modifier = Modifier.padding(horizontal = MnemaSpacing.Small)
                ) {
                    Icon(
                        Icons.Default.Add,
                    ...
                    Spacer(Modifier.width(MnemaSpacing.XSmall))
                    Text("New collection")
                }
            }
        }
