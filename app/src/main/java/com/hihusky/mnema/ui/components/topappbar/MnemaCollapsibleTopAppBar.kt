package com.hihusky.mnema.ui.components.topappbar
...
fun MnemaCollapsibleTopAppBar(
    ...
    val expandedHeight = MnemaSize.TopBarExpanded
    val collapsedHeight = MnemaSize.TopBarCollapsed
    ...
    Column(modifier = modifier.fillMaxWidth()) {
        ...
        Box(modifier = Modifier.fillMaxWidth().height(currentHeight)) {
            ...
            Box(
                modifier = Modifier
                    .fillMaxSize()
                    .padding(end = MnemaSpacing.Small),
            ...
            Box(
                modifier = Modifier
                    .fillMaxSize()
                    .padding(start = MnemaSpacing.XSmall),
