...
interface StudySessionDao {
    ...
    @Query("SELECT * FROM study_sessions WHERE bookId IN (:bookIds) AND isActive = 1 ORDER BY lastActiveTime DESC")
    suspend fun getActiveSessionsForBooks(bookIds: List<Int>): List<StudySessionEntity>
