...
class UserAnswerRepository
    ...
    constructor(
        ...
        suspend fun getUserAnswers(bookId: Int): Map<Int, UserAnswer> =
            db.userAnswerDao().getByBookId(bookId).associate {
                it.questionId to
                    UserAnswer(
        ...
        suspend fun getMarkedQuestions(bookId: Int): Set<Int> = db.userAnswerDao().getMarkedQuestionIds(bookId).toSet()

        suspend fun setUserMark(
            bookId: Int,
            questionId: Int,
            isMarked: Boolean,
        ) {
        ...
        suspend fun getWrongQuestionIds(bookId: Int): List<Int> = db.userAnswerDao().getWrongQuestionIds(bookId)

        suspend fun getAnsweredQuestionIds(bookId: Int): List<Int> = db.userAnswerDao().getAnsweredQuestionIds(bookId)
    }
