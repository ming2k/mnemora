package com.hihusky.mnemora.ui.screens.review
...
private fun ReviewContent(
    ...
    Column(
            ...
            FilledTonalButton(
                ...
                Row(
                    ...
                    Text(
                        ...
                        color = contentColor.copy(alpha = MnemoraAlpha.Strong)
                    )
                }
            }
        ...
        Text(
            ...
            color = MaterialTheme.colorScheme.onSurfaceVariant.copy(alpha = MnemoraAlpha.Deemphasized),
            modifier = Modifier.align(Alignment.CenterHorizontally)
        )
    }
}
