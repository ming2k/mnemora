                ...
                try {
                    ...
                    if (!fileName.lowercase().endsWith(".zip") &&
                        ...
                        return@withContext ImportResult.Error(
                            "Invalid file type. Please select a .zip, .quizpkg, or .mnemorapkg file.",
                        )
                    }
                    ...
                    val error =
                        bookImporter.importData(plainMap, packageId) { importProgress ->
