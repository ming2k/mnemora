...
class BookImporterTest {
    ...
    @Test
    fun `importData skips if already imported`() =
        runTest {
    ...
    @Test
    fun `importData inserts book entity`() =
        runTest {
            val data =
                mapOf<String, Any?>(
                    "name" to "Test Book",
    ...
    @Test
    fun `importData inserts node entities`() =
        runTest {
            val data =
                mapOf<String, Any?>(
                    "name" to "Book",
    ...
    @Test
    fun `importData inserts question entities`() =
        runTest {
            val data =
                mapOf<String, Any?>(
                    "name" to "Book",
    ...
    @Test
    fun `importData builds nested node hierarchy`() =
        runTest {
            val data =
                mapOf<String, Any?>(
                    "name" to "Nested Book",
    ...
    @Test
    fun `importData stores choices as JSON`() =
        runTest {
            val data =
                mapOf<String, Any?>(
                    "name" to "Book",
    ...
    @Test
    fun `importData sets total counts on book`() =
        runTest {
            val data =
                mapOf<String, Any?>(
                    "name" to "Count Book",
    ...
    @Test
    fun `importData reports progress`() =
        runTest {
