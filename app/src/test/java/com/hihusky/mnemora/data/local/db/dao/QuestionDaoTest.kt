...
class QuestionDaoTest {
    ...
    @Test
    fun `query by nodeId returns questions for that node`() =
        runTest {
    ...
    @Test
    fun `query by ids returns multiple questions`() =
        runTest {
    ...
    @Test
    fun `getAnswerableQuestionIds excludes passage type`() =
        runTest {
            createTestData(1, "node_1", "node_2")
    ...
    @Test
    fun `deleteByBookId removes all questions for book`() =
        runTest {
            createTestData(1, "node_1")
