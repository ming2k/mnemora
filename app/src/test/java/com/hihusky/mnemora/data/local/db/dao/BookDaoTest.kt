...
class BookDaoTest {
    ...
    @Test
    fun `getAllOnce returns all books`() =
        runTest {
    ...
    @Test
    fun `search finds books by name`() =
        runTest {
    ...
    @Test
    fun `search finds books by filename`() =
        runTest {
    ...
    @Test
    fun `insert replaces on conflict`() =
        runTest {
    ...
    @Test
    fun `updateSortOrder changes sort order`() =
        runTest {
