...
class NodeDaoTest {
    ...
    private suspend fun createTestBook(): Long = bookDao.insert(BookEntity(filename = "test_pkg", name = "Test Book"))

    @Test
    fun `insert and query by bookId`() =
        runTest {
    ...
    @Test
    fun `flow emits nodes by bookId`() =
        runTest {
            val bookId = createTestBook().toInt()
    ...
    @Test
    fun `query by node id returns correct node`() =
        runTest {
            val bookId = createTestBook().toInt()
    ...
    @Test
    fun `getById returns null for missing node`() =
        runTest {
    ...
    @Test
    fun `parent-child hierarchy queries work`() =
        runTest {
            val bookId = createTestBook().toInt()
    ...
    @Test
    fun `delete by bookId removes all nodes for that book`() =
        runTest {
    ...
    @Test
    fun `insertAll inserts multiple nodes`() =
        runTest {
            val bookId = createTestBook().toInt()
